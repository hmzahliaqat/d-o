...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Clickesignature - Share' },
    { description: 'I just signed a document in style with Clickesignature!' },
    {
      property: 'og:title',
      content: 'Clickesignature - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Clickesignature!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for Clickesignature.
  throw redirect('https://clickesignature.com');
};
